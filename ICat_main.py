...
#file_path = "/mnt/c/Ben_workspace/PythonCode/ICat/Dataset/ICatDataset_detaG.xlsx" # Dataset Path
#file_path2 = "/mnt/c/Ben_workspace/PythonCode/ICat/Dataset/feature_name2.xlsx"
#file_path3 = "/mnt/c/Ben_workspace/PythonCode/ICat/Dataset/ICatDataset100.xlsx" 
#feature_name_fp = pd.read_excel(file_path2, sheet_name=sheet_name)
#features_fp = pd.read_excel(file_path3, sheet_name=sheet_name) # Read reaction data

#'''

# xgb model
#X_train, X_test, y_train, y_test = train_test_split(features_fp, targets_temp, test_size=0.2, random_state=42)
#final_r2, rmse, train_pred, y_pred, feature_importance_df = xgb_reg.xgboost_regression_optimization(X_train, y_train, X_test, y_test, feature_name = feature_name_fp)
#features_fp = pd.DataFrame(features_fp)
#feature_importance_df.to_excel('/mnt/c/Ben_workspace/PythonCode/ICat/Dataset/feature_importance_df_0923.xlsx')
